...
public class SceneHandler : MonoBehaviour
{
    ...
    private string[] Scenes = { "TheWhisperingInn", "TownScene", "Townscene", "TownScene", "TownScene", "TownScene", "Townscene", "TownScene", "ChurchScene" }; //TownScene exits in order = 
    // WhisperingInn(1), Alex (2), Paul (3), Nadine (4), Matthew (5), Julia (6), Church exit (7)
